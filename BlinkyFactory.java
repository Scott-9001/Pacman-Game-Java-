...
public class BlinkyFactory implements RenderableFactory {
    ...
    public Renderable createRenderable(
        ...
        try {
            ...
            Ghost blinkyImpl = new GhostImpl(GHOST_IMAGE, boundingBox, kinematicState, GhostMode.SCATTER, targetCorners.get(1));
            Ghost blinky = new BlinkyDecorator(blinkyImpl);
            ((GhostImpl)blinkyImpl).setDecorator(blinky);
            return blinky;
