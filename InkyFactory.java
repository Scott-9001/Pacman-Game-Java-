...
public class InkyFactory implements RenderableFactory {
    ...
    public Renderable createRenderable(
        ...
        try {
            ...
            Ghost inkyImpl = new GhostImpl(GHOST_IMAGE, boundingBox, kinematicState, GhostMode.SCATTER, targetCorners.get(3));
            Ghost inky = new InkyDecorator(inkyImpl);
            ((GhostImpl)inkyImpl).setDecorator(inky);
            return inky;
