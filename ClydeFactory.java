...
import pacman.model.entity.dynamic.ghost.ClydeDecorator;
...
public class ClydeFactory implements RenderableFactory {
    ...
    public Renderable createRenderable(
        ...
        try {
            ...
            Ghost clydeImpl = new GhostImpl(GHOST_IMAGE, boundingBox, kinematicState, GhostMode.SCATTER, targetCorners.get(2));
            Ghost clyde = new ClydeDecorator(clydeImpl);
            ((GhostImpl)clydeImpl).setDecorator(clyde);
            return clyde;
