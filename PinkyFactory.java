...
import pacman.model.entity.dynamic.ghost.PinkyDecorator;
...
public class PinkyFactory implements RenderableFactory {
    ...
    public Renderable createRenderable(
        ...
        try {
            ...
            Ghost pinkyImpl = new GhostImpl(GHOST_IMAGE, boundingBox, kinematicState, GhostMode.SCATTER, targetCorners.get(0));
            Ghost pinky = new PinkyDecorator(pinkyImpl);
            ((GhostImpl)pinkyImpl).setDecorator(pinky);
            return pinky;
